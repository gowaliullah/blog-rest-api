...
func Users() {
	user1 := models.User{ID: 5, Name: "Edward Clark", Email: "edward.c@example.com", Password: "hashed_password_5"}
	...
	UserList = append(UserList, user1, user2, user3, user4, user5, user5, user6)
}
